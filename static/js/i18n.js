...
(function () {
  ...
  var translations = {
    ...
    "首页":"Home", "在下方输入 Bot Token 或 User Token 添加下载账号。":"Enter a Bot Token or User Token below to add a download account.",
    "选择要参与下载的机器人；第一个负责扫描帖子，其余并行下载。":"Pick the bots to use; the first one scans threads while the rest download in parallel.",
    "每个机器人按批次下载帖子，多机器人并行。":"Each bot downloads threads in batches, running in parallel.",
    "下载器轮询任务队列的间隔（毫秒）。":"Task queue poll interval in milliseconds.",
    "同一机器人在两个帖子之间的等待时间（毫秒），0 为不等待。":"Delay between a bot's threads in milliseconds; 0 disables waiting.",
    "支持暂停 / 继续 / 删除；继续时只处理未完成帖子。":"Pause, resume, or delete tasks; resuming processes only unfinished threads.",
    "开启后只下载新增或有变化的帖子。":"When enabled, only new or changed threads are downloaded.",
    "由白名单机器人自动维护，新成员实时入库。":"Maintained by the whitelist bot; new members are recorded in real time.",
    "创建下载任务":"Create download task", "删除":"Delete", "删除下载":"Delete download", "删除机器人":"Delete bot", "删除配置":"Delete config", "加入机器人":"Add bot", "取消任务":"Cancel task", "暂停下载":"Pause", "继续下载":"Resume", "通过":"Approve", "解除":"Unmerge", "已下载 / 总数":"Done / Total", "已运行时间":"Elapsed", "并行下载":"Parallel downloads", "预计剩余":"ETA", "阶段":"Phase", "机器人":"Bot", "毫秒":"ms", "默认下载机器人":"Default download bot", "机器人下载速度":"Bot download speed", "任务调度检查间隔":"Task queue poll interval", "服务器数据更新":"Server data updates", "清空当前服务器认领数据":"Reset claimed accounts for this server", "没有可访问论坛频道":"No accessible forum channels", "正在读取服务器…":"Loading server…", "选择要加入的机器人":"Select bots to join", "立即更新成员名单":"Sync members now", "请先选择服务器":"Select a server first", "请先配置下载 Forum":"Configure the forum channel first", "请先配置下载服务器":"Configure the server first", "请给机器人授予权限、邀请机器人加入服务器，或取消选择后重新保存。":"Grant the bot permissions, invite it to the server, or deselect it and save again.", "请重新登录 Discord":"Please log in to Discord again", "User Token 仅用于 DiscordChatExporter/REST 下载。Discord 对自动化用户账号有限制，请优先使用 Bot Token；任何 Token 都等同密码，切勿分享。":"User Tokens are for DiscordChatExporter/REST downloads only. Prefer a Bot Token — Discord restricts automated user accounts. Treat tokens like passwords.", "由 whitelist_bot.py 自动维护":"Maintained automatically by whitelist_bot.py", "白名单用于 JSON 导入和下载配额管理；普通用户查看已收录数据不需要白名单。":"The whitelist governs JSON imports and download quotas; browsing collected data doesn't require it.", "🏆 完整活跃榜单":"🏆 Full leaderboard", "🏆 活跃成员排行榜 (Top 200)":"🏆 Active members (Top 200)", "↓ 下滑查看更多":"↓ Scroll down for more", "❤️ 最受欢迎的消息":"❤️ Most popular message", "📅 发言最多的一天":"📅 Most active day", "🔥 引发热议的帖子":"🔥 Most discussed thread", "🔗 认领此账号":"🔗 Claim this account", "确定删除该白名单用户？":"Remove this user from the whitelist?", "确定删除这个下载机器人？":"Remove this download bot?",
    "你的 Discord 账号已经登录成功，但暂时没有与你关联的服务器数据。":"Your Discord account is signed in, but no server data is associated with you yet.",
    "系统已经识别你的 Discord 账号。普通用户只要出现在已收录的服务器数据中，就会自动获得访问权限；如果你还没有被收录，请等待管理员导入对应服务器数据。":"Your Discord account is recognized. Regular users get access automatically once they appear in collected server data; if you're not included yet, wait for an admin to import that server's data.",
    "如果你是服务器普通成员，不需要加入白名单。管理员导入服务器数据后，系统会自动建立你的普通用户数据记录。":"Regular server members don't need the whitelist. Once an admin imports server data, your member record is created automatically.",
    "普通用户出现在服务器数据中即可自动获得访问权限。":"Regular users get access automatically once they appear in collected data.",
    "支持多个 Discord 服务器。登录后，系统会根据 Discord User ID 自动匹配你有权限访问的数据。":"Supports multiple Discord servers. After login, your accessible data is matched automatically by Discord User ID.",
    "这是一个用于展示 Discord Analytics Dashboard 核心体验的轻量演示版本，内置示例服务器、成员、消息和报告数据。进入演示即可体验页面之间的切换和数据浏览；正式版的数据导入、下载任务和管理功能不会出现在这里。":"A lightweight demo of the core Dashboard experience with sample servers, members, messages, and reports. Browse freely — data import, download tasks, and admin features are not included.",
    "关于演示网站":"About the demo", "查看服务器概览、用户资料、消息统计和报告。":"Server overviews, profiles, message stats, and reports.",
    "通过 Discord OAuth2 安全识别用户。":"Users are verified securely via Discord OAuth2.",
    "你的 Discord 数据，集中分析。":"All your Discord analytics in one place."
  };
